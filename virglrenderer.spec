...
%global commit aefb89536ab19b76ab33a10032e1f8c2c47fdb15
%global shortcommit %(c=%{commit}; echo ${c:0:7})

%global forgeurl https://gitlab.freedesktop.org/virgl/virglrenderer

Name:           virglrenderer
Version:        1.0.1.asahikrun^%{date}git%{shortcommit}
Release:        1%{?dist}
...
Patch0:   0001-drm-implement-native-context-support-for-asahi.patch
...
%build
%meson -Dvideo=true -Dvenus=true -Ddrm-asahi-experimental=true
%meson_build
